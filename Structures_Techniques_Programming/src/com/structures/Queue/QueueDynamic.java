...
public class QueueDynamic<T> implements QueueInterface<T>
{
	...
	* @param queue.
	*/
	public QueueDynamic (QueueInterface<T> queue) {
		this ();
		if (queue != null)
	...
	* @param list.
	*/
	public QueueDynamic (ListInterface<T> list)
	{
		this ();
		if (list != null) {
	...
	{
		QueueInterface<T> handler = new QueueDynamic<T> (this);
	...
	public String toString ()
	{
		...
		IteratorInterface<T> queueIt = getIterator ();
